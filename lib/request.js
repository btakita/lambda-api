...
class REQUEST {
  ...
  // Parse the request
  async parseRequest() {
console.debug('lambda-api|parseRequest|debug|1')
...
console.debug('lambda-api|parseRequest|debug|2')
...
console.debug('lambda-api|parseRequest|debug|4.2')
...
console.debug('lambda-api|parseRequest|debug|4.3')
console.debug('lambda-api|parseRequest|debug|4.4', JSON.stringify({
  'this.app._event': this.app._event,
  'this.app._event.body': this.app._event.body,
}))
...
console.debug('lambda-api|parseRequest|debug|5')
    // Set the body
    if (this.headers['content-type'] && this.headers['content-type'].includes('application/x-www-form-urlencoded')) {
      console.debug('lambda-api|parseRequest|debug|5.1')
      this.body = QS.parse(this.body)
    } else if (typeof this.body === 'object') {
      console.debug('lambda-api|parseRequest|debug|5.2')
      this.body = this.body
    } else {
      console.debug('lambda-api|parseRequest|debug|5.3')
      this.body = UTILS.parseBody(this.body)
    }
console.debug('lambda-api|parseRequest|debug|6')
    ...
    // Init wildcard
    let wc = []
console.debug('lambda-api|parseRequest|debug|7', JSON.stringify({
  routes,
}))
...
console.debug('lambda-api|parseRequest|debug|7')
